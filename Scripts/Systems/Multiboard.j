	...
	function RegisterHeroDeathCondition takes nothing returns boolean
		return IsUnitType( GetDyingUnit( ), UNIT_TYPE_HERO ) and IsUnitAlly( GetKillingUnit( ), GetOwningPlayer( GetDyingUnit( ) ) ) != true and GetOwningPlayer( GetDyingUnit( ) ) != Player( PLAYER_NEUTRAL_AGGRESSIVE )
	endfunction

	function RegisterHeroDeathAction takes nothing returns nothing
